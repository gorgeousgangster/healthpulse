  ...
  return (
    <form onSubmit={handleSubmit} className="card">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        <InputField label={t('form.age')} name="age" placeholder="30" value={form.age} onChange={handleChange} error={errors.age} suffix={t('form.years')} hint={t('form.hints.age')} />
        <InputField label={t('form.height')} name="height_cm" placeholder="170" value={form.height_cm} onChange={handleChange} error={errors.height_cm} suffix={t('form.cm')} hint={t('form.hints.height')} />
        <InputField label={t('form.weight')} name="weight_kg" placeholder="70" value={form.weight_kg} onChange={handleChange} error={errors.weight_kg} suffix={t('form.kg')} hint={t('form.hints.weight')} />
        ...
        <div>
          ...
          <p className="text-xs mt-1 text-gray-400">{t('form.hints.bmi')}</p>
        </div>

        <InputField label={t('form.systolic')} name="blood_pressure_systolic" placeholder="120" value={form.blood_pressure_systolic} onChange={handleChange} error={errors.blood_pressure_systolic} suffix={t('form.mmHg')} hint={t('form.hints.systolic')} />
        <InputField label={t('form.diastolic')} name="blood_pressure_diastolic" placeholder="80" value={form.blood_pressure_diastolic} onChange={handleChange} error={errors.blood_pressure_diastolic} suffix={t('form.mmHg')} hint={t('form.hints.diastolic')} />
        <InputField label={t('form.cholesterol')} name="cholesterol" placeholder="200" value={form.cholesterol} onChange={handleChange} error={errors.cholesterol} suffix={t('form.mgdl')} hint={t('form.hints.cholesterol')} />
        <InputField label={t('form.glucose')} name="glucose" placeholder="90" value={form.glucose} onChange={handleChange} error={errors.glucose} suffix={t('form.mgdl')} hint={t('form.hints.glucose')} />
        <InputField label={t('form.alcohol')} name="alcohol_weekly_units" placeholder="0" value={form.alcohol_weekly_units} onChange={handleChange} error={errors.alcohol_weekly_units} suffix={t('form.units')} hint={t('form.hints.alcohol')} />
        <InputField label={t('form.exercise')} name="exercise_hours_weekly" placeholder="2.5" value={form.exercise_hours_weekly} onChange={handleChange} error={errors.exercise_hours_weekly} suffix={t('form.hours')} hint={t('form.hints.exercise')} />
        <InputField label={t('form.sleep')} name="sleep_hours_daily" placeholder="7.5" value={form.sleep_hours_daily} onChange={handleChange} error={errors.sleep_hours_daily} suffix={t('form.hours')} hint={t('form.hints.sleep')} />
        <InputField label={t('form.stress')} name="stress_level" placeholder="5" value={form.stress_level} onChange={handleChange} error={errors.stress_level} suffix={t('form.of10')} hint={t('form.hints.stress')} />
      </div>
...
function InputField({ label, name, placeholder, value, onChange, error, suffix, hint }) {
  return (
    <div>
